...
const values = [
  {
    Icon: FaFire,
    title: 'Intensity',
    body: 'We bring full force to everything — our formula, our brand, our community.',
  },
  {
    Icon: FaShieldAlt,
    title: 'Integrity',
    body: 'No hidden ingredients. No false claims. What you see is exactly what you get.',
  },
  {
    Icon: FaFlask,
    title: 'Innovation',
    body: 'We constantly push the formula forward. Comfort zones are for other brands.',
  },
  {
    Icon: FaUsers,
    title: 'Community',
    body: 'Built by athletes, for athletes. Every decision we make starts with our people.',
  },
]
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4" style={{ gap: '32px' }}>
          {values.map((v, i) => (
            <motion.div
              ...
              className="group text-center p-8 rounded-[20px] bg-[#0d2240]/40 border border-sky-900/30 hover:border-sky-500/30 transition-all duration-300 hover:-translate-y-1"
            >
              {/* Icon */}
              ...
              {/* Title */}
              <h3 className="font-bebas text-2xl text-white tracking-wider" style={{ marginBottom: '8px' }}>
                {v.title}
              </h3>
              {/* Body */}
